...
from ilids.models.actionclip.model import TextCLIP, ImageCLIP
...
def create_models_and_transforms(
    ...
    model = open_clip.load_openai_model(openai_model_name, device=device, jit=jit)  # Must set jit=False for training  ViT-B/32 TODO: try jit=True
